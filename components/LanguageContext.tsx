...
const translations = {
    en: {
        ...
        profile_social_title: 'Social style links',
        profile_social_subtitle: 'Connect your StyleSwap closet to social platforms so your friends can shop your looks.',
        profile_social_instagram: 'Instagram handle',
        profile_social_tiktok: 'TikTok username',
        profile_social_pinterest: 'Pinterest profile or board URL',
        profile_social_youtube: 'YouTube channel URL',
        profile_social_placeholder: 'Add link or @username',
        profile_social_status_connected: 'Connected',
        profile_social_status_disconnected: 'Not connected yet',
        ...
        product_share_title: 'Share this find',
        product_share_subtitle: 'Bring your friends into the AI fitting room by sharing this product.',
        product_share_copy_link: 'Copy link',
        product_share_copied: 'Link copied!',
        product_share_native: 'Share with device',
        product_share_facebook: 'Facebook',
        product_share_twitter: 'X (Twitter)',
        product_share_pinterest: 'Pinterest',
        product_share_whatsapp: 'WhatsApp',
    },
    th: {
        app_title_part1: 'STYLE',
        app_title_part2: 'SWAP',
        ...
        profile_social_title: 'ลิงก์โซเชียลของสไตล์คุณ',
        profile_social_subtitle: 'เชื่อมต่อคลังเสื้อผ้า StyleSwap กับบัญชีโซเชียล เพื่อให้เพื่อนๆ มาช้อปร่วมกันได้',
        profile_social_instagram: 'บัญชี Instagram',
        profile_social_tiktok: 'ชื่อผู้ใช้ TikTok',
        profile_social_pinterest: 'ลิงก์โปรไฟล์หรือบอร์ด Pinterest',
        profile_social_youtube: 'ลิงก์ช่อง YouTube',
        profile_social_placeholder: 'เพิ่มลิงก์หรือ @ชื่อผู้ใช้',
        profile_social_status_connected: 'เชื่อมต่อแล้ว',
        profile_social_status_disconnected: 'ยังไม่ได้เชื่อมต่อ',
        ...
        product_share_title: 'แชร์สินค้าชิ้นนี้',
        product_share_subtitle: 'ชวนเพื่อนๆ มาลองใส่ในห้องลองเสมือนไปด้วยกัน',
        product_share_copy_link: 'คัดลอกลิงก์',
        product_share_copied: 'คัดลอกลิงก์แล้ว!',
        product_share_native: 'แชร์ผ่านอุปกรณ์',
        product_share_facebook: 'Facebook',
        product_share_twitter: 'X (Twitter)',
        product_share_pinterest: 'Pinterest',
        product_share_whatsapp: 'WhatsApp',
    ...
    zh: {
        ...
        profile_social_title: '社交媒体链接',
        profile_social_subtitle: '将您的 StyleSwap 衣橱连接到社交平台，与朋友分享您的穿搭。',
        profile_social_instagram: 'Instagram 帐号',
        profile_social_tiktok: 'TikTok 用户名',
        profile_social_pinterest: 'Pinterest 个人主页/看板链接',
        profile_social_youtube: 'YouTube 频道链接',
        profile_social_placeholder: '添加链接或 @用户名',
        profile_social_status_connected: '已连接',
        profile_social_status_disconnected: '尚未连接',
        admin_table_name: '姓名',
        ...
        product_share_title: '分享这件好物',
        product_share_subtitle: '把好友一起带进虚拟试衣间吧。',
        product_share_copy_link: '复制链接',
        product_share_copied: '链接已复制！',
        product_share_native: '使用设备分享',
        product_share_facebook: 'Facebook',
        product_share_twitter: 'X (Twitter)',
        product_share_pinterest: 'Pinterest',
        product_share_whatsapp: 'WhatsApp',
